...
class textLabel:
    ...
    def drawLabel(self):
        self._var = StringVar()
        self.lab = Label(self._parentMaze._canvas, textvariable=self._var, bg="black", fg="white",font=('Helvetica bold',12),relief=RIDGE)
        self._var.set(f'\t {self.title} : {self.value} \t')
        self.lab.pack(expand = True,side=TOP,anchor=E)

  
class textLabelJudul1:
    '''
    This class is to create Text Label to show different results on the window.
    '''
    def __init__(self,parentMaze,title):
        '''
        parentmaze-->   The maze on which Label will be displayed.
        title-->        The title of the value to be displayed
        value-->        The value to be displayed
    ...
    def drawLabel(self):
        self._var = StringVar()
        self.lab = Label(self._parentMaze._canvas, textvariable=self._var, bg="red", fg="white",font=('Helvetica bold',12),relief=RIDGE)
        self._var.set(f'\t {self.title} \t')
        self.lab.pack(expand = False,side=TOP,anchor=E)
        
class textLabelJudul2:
    '''
    This class is to create Text Label to show different results on the window.
    '''
    def __init__(self,parentMaze,title):
    ...
    def drawLabel(self):
        self._var = StringVar()
        self.lab = Label(self._parentMaze._canvas, textvariable=self._var, bg="blue", fg="white",font=('Helvetica bold',12),relief=RIDGE)
        self._var.set(f'\t {self.title} \t')
        self.lab.pack(expand = False,side=TOP,anchor=E)

class textLabelJudul3:
    '''
    This class is to create Text Label to show different results on the window.
    '''
    def __init__(self,parentMaze,title):
    ...
    def drawLabel(self):
        ...
        self._var.set(f'\t {self.title} \t')
        self.lab.pack(expand = False,side=TOP,anchor=CENTER)
...
class maze:
    ...
    def _drawMaze(self,theme):
        ...
        self._win.title('Tugas Besar Strategi Algoritma : Jalan Keluar Labirin')
